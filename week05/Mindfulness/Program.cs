...
class Program
{
    ...
    {
        DisplayWelcome();
        BreathingActivity activity1 = new BreathingActivity("Breathing", "This activity will help you relax by walking your through breathing "
                     + "in and out slowly. Clear your mind and focus on your breathing.");
        ListeningActivity activity2 = new ListeningActivity("Listening", "This activity will help you reflect on the good things in your life "
                        + "by having you list as many things as you can in a certain area.");
        ReflectingActivity activity3 = new ReflectingActivity("Reflecting", "This activity will help you reflect on times in your life when you have "
